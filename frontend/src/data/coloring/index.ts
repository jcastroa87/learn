...
const templates: ColoringTemplate[] = [
  ...
  { id: "cat-1", category: "animals", name: { es: "Gato", en: "Cat", ru: "Кот" }, regions: [
    ...
    { id: "ear-inner-l", path: "M37,22 L34,12 L41,19Z", defaultFill: "#f5f5f5" },
    { id: "ear-inner-r", path: "M63,22 L66,12 L59,19Z", defaultFill: "#f5f5f5" },
    { id: "eye-l", path: "M42,28 A3,3 0 1,0 48,28 A3,3 0 1,0 42,28Z", defaultFill: "#f5f5f5" },
    { id: "eye-r", path: "M52,28 A3,3 0 1,0 58,28 A3,3 0 1,0 52,28Z", defaultFill: "#f5f5f5" },
    { id: "nose", path: "M48,33 L50,31 L52,33Z", defaultFill: "#f5f5f5" },
    { id: "tail", path: "M70,65 Q85,50 80,35 Q78,30 75,35 Q78,50 65,60Z", defaultFill: "#f5f5f5" },
    { id: "paw-l", path: "M35,72 Q33,80 38,82 Q42,80 40,72Z", defaultFill: "#f5f5f5" },
    { id: "paw-r", path: "M60,72 Q58,80 62,82 Q66,80 65,72Z", defaultFill: "#f5f5f5" },
    { id: "belly", path: "M42,55 Q42,48 50,46 Q58,48 58,55 Q50,60 42,55Z", defaultFill: "#f5f5f5" },
  ]},
  { id: "dog-1", category: "animals", name: { es: "Perro", en: "Dog", ru: "Собака" }, regions: [
    ...
    { id: "eye-l", path: "M40,30 A3,3 0 1,0 46,30 A3,3 0 1,0 40,30Z", defaultFill: "#f5f5f5" },
    { id: "eye-r", path: "M54,30 A3,3 0 1,0 60,30 A3,3 0 1,0 54,30Z", defaultFill: "#f5f5f5" },
    { id: "nose", path: "M46,37 A4,3 0 1,0 54,37 A4,3 0 1,0 46,37Z", defaultFill: "#f5f5f5" },
    { id: "mouth", path: "M46,40 Q50,45 54,40", defaultFill: "#f5f5f5" },
    { id: "collar", path: "M35,46 Q50,52 65,46 Q65,49 50,55 Q35,49 35,46Z", defaultFill: "#f5f5f5" },
    { id: "tail", path: "M75,60 Q88,45 85,55 Q82,65 75,68Z", defaultFill: "#f5f5f5" },
    { id: "paw-l", path: "M32,76 Q30,84 36,85 Q40,83 38,76Z", defaultFill: "#f5f5f5" },
    { id: "paw-r", path: "M62,76 Q60,84 64,85 Q68,83 68,76Z", defaultFill: "#f5f5f5" },
    { id: "belly", path: "M40,58 Q40,52 50,50 Q60,52 60,58 Q50,64 40,58Z", defaultFill: "#f5f5f5" },
  ]},
  ...
  { id: "car-1", category: "vehicles", name: { es: "Coche", en: "Car", ru: "Машина" }, regions: [
    ...
    { id: "roof", path: "M35,35 L38,25 L62,25 L65,35Z", defaultFill: "#f5f5f5" },
    ...
    { id: "headlight-l", path: "M15,58 A3,3 0 1,0 21,58 A3,3 0 1,0 15,58Z", defaultFill: "#f5f5f5" },
    { id: "headlight-r", path: "M79,58 A3,3 0 1,0 85,58 A3,3 0 1,0 79,58Z", defaultFill: "#f5f5f5" },
    { id: "bumper", path: "M12,70 L12,74 L88,74 L88,70Z", defaultFill: "#f5f5f5" },
    { id: "door-handle", path: "M42,56 L52,56 L52,58 L42,58Z", defaultFill: "#f5f5f5" },
    ...
    { id: "hubcap-l", path: "M25,76 A3,3 0 1,0 31,76 A3,3 0 1,0 25,76Z", defaultFill: "#f5f5f5" },
    { id: "hubcap-r", path: "M69,76 A3,3 0 1,0 75,76 A3,3 0 1,0 69,76Z", defaultFill: "#f5f5f5" },
  ]},
  ...
  { id: "flower-1", category: "nature", name: { es: "Flor", en: "Flower", ru: "Цветок" }, regions: [
    ...
    { id: "petal-t", path: "M45,33 Q43,18 50,15 Q57,18 55,33Z", defaultFill: "#f5f5f5" },
    { id: "petal-tr", path: "M56,35 Q65,22 70,30 Q68,38 58,38Z", defaultFill: "#f5f5f5" },
    { id: "petal-r", path: "M57,42 Q72,38 72,45 Q68,50 57,46Z", defaultFill: "#f5f5f5" },
    { id: "petal-br", path: "M56,48 Q68,52 65,60 Q58,58 55,50Z", defaultFill: "#f5f5f5" },
    { id: "petal-b", path: "M45,47 Q43,62 50,65 Q57,62 55,47Z", defaultFill: "#f5f5f5" },
    { id: "petal-bl", path: "M44,48 Q32,52 35,60 Q42,58 45,50Z", defaultFill: "#f5f5f5" },
    { id: "petal-l", path: "M43,42 Q28,38 28,45 Q32,50 43,46Z", defaultFill: "#f5f5f5" },
    { id: "petal-tl", path: "M44,35 Q35,22 30,30 Q32,38 42,38Z", defaultFill: "#f5f5f5" },
    { id: "stem", path: "M48,55 L48,85 L52,85 L52,55Z", defaultFill: "#f5f5f5" },
    { id: "leaf-l", path: "M48,68 Q35,60 30,65 Q33,72 48,72Z", defaultFill: "#f5f5f5" },
    { id: "leaf-r", path: "M52,74 Q65,66 70,71 Q67,78 52,78Z", defaultFill: "#f5f5f5" },
  ]},
  ...
  { id: "star-1", category: "fantasy", name: { es: "Estrella", en: "Star", ru: "Звезда" }, regions: [
    { id: "point-t", path: "M50,10 L60,38 L50,32 L40,38Z", defaultFill: "#f5f5f5" },
    { id: "point-tr", path: "M60,38 L90,38 L66,55 L58,45Z", defaultFill: "#f5f5f5" },
    { id: "point-br", path: "M66,55 L76,85 L50,66 L58,55Z", defaultFill: "#f5f5f5" },
    { id: "point-bl", path: "M50,66 L24,85 L34,55 L42,55Z", defaultFill: "#f5f5f5" },
    { id: "point-tl", path: "M34,55 L10,38 L40,38 L42,45Z", defaultFill: "#f5f5f5" },
    { id: "center", path: "M50,32 L58,45 L58,55 L50,66 L42,55 L42,45Z", defaultFill: "#f5f5f5" },
    { id: "eye-l", path: "M44,44 A2,2 0 1,0 48,44 A2,2 0 1,0 44,44Z", defaultFill: "#f5f5f5" },
    { id: "eye-r", path: "M52,44 A2,2 0 1,0 56,44 A2,2 0 1,0 52,44Z", defaultFill: "#f5f5f5" },
    { id: "smile", path: "M46,50 Q50,55 54,50 Q50,52 46,50Z", defaultFill: "#f5f5f5" },
  ]},
